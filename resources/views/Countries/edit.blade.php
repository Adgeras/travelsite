                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('countries.update', $countries->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="" class="form-control" value="{{ $countries->distance }}">
                        </div>
                        <div class="form-group">
                            <label for="">Aprašas</label>
                            <textarea id="mce" type="text" name="description" rows=10 cols=100 class="form-control">{{ $countries->description }}</textarea>
                        </div>
