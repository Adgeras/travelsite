            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customers.update', $customers->id) }}">
                        ...
                        <div class="form-group">
                            <label>Pavardė: </label>
                            <input type="text" name="surname" class="form-control" value="{{ $customers->surname }}"> 
                        </div>
                        <div class="form-group">
                            <label>Email: </label>
                        ...
                        <div class="form-group">
                            ...
                            <select name="country_id" id="" class="form-control">
                                ...
                                <option value="{{ $country->id }}" @if($country->id == $customers->country_id) selected="selected" @endif>{{ $country->title }}</option>
                                @endforeach
                            </select>
                        </div>
